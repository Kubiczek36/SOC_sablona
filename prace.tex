...
Při samotném psaná rozhodně nevytvářej samostatný dokument, vymaž text co je v šabloně a nahraď jej tí tvým. Při psaní je dobré sledovat komentáře ve zdrojovém kódu, díky nim snáz pochopíš, k čemu je jaký příkaz. V případě kdyby něco nesedělo, nebo si na mě měl jakýkoli dotaz, tak se na mě můžeš jednak obrátit na GitHubu \cite{sablonaSOC}, kde je tato šablona uložena, a nebo přímo na můj mail \url{kubadokulil99@gmail.com} %% příkaz url pro sazbu odkazů
