...
%% Proměnné
\newcommand\city{Nový New York} %% vyplň oficiální název města
\newcommand\district{Galaktický kraj} %% vyplň oficiální název kraje
\newcommand\specialization{Obor č. 21: Futuramologie} %% -- napiš číslo a název tvého oboru
\newcommand\school{Mars University} %% vyplň název školy
\newcommand\consultant{prof. Hubert J. Farnsworth} %% vyplň jméno svého konzultanta
\newcommand\authorName{Philip J. Fry}  %% vyplň své jméno
\newcommand\publicationYear{3020} %% vyplň rok
\newcommand\mainTitle{Pojednání o vražedném Santovi} %% vyplň název své práce
