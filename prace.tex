...
\lstset{language=Python, %% sem napiš jaký programovací jazyk používáš,
% úplný seznam viz: https://en.wikibooks.org/wiki/LaTeX/Source_Code_Listings
% převzato a upraveno z https://en.wikibooks.org/wiki/LaTeX/Source_Code_Listings
...
\begin{figure}[h] \centering
    \begin{subfigure}{0.6\textwidth} %% šířka podobrázku
...
\lstinputlisting[language=TeX, firstline=73, lastline=90, caption={Kód nastavení výpisu.}]{prace.tex}
